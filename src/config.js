...
module.exports = {
  ...
  category_one_payment_per_student: 0, // Free category
  category_two_payment_per_student: 0.00001,
  category_three_payment_per_student: 0.00002,
  category_four_payment_per_student: 0.00003
};
